@echo off
rem Build WCP Sentence Audio RU plugin (BepInEx 5, C#5 via NETFX csc)
rem Game dir: override with WCP_GAME_DIR, default is the active install.
...
"%CSC%" /nologo /noconfig /nostdlib+ /target:library /langversion:5 /optimize+ %REFS% ^
 /out:"%~dp0SentenceAudioRuMod.dll" "%~dp0SentenceAudioRuMod.cs"
if errorlevel 1 (echo BUILD FAILED & exit /b 1)
echo BUILD OK
copy /y "%~dp0SentenceAudioRuMod.dll" "%GAME%\BepInEx\plugins\SentenceAudioRuMod.dll" >nul
if errorlevel 1 (
