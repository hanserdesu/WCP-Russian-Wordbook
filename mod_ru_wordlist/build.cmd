@echo off
rem Build WCP RU Word List plugin (BepInEx 5, C#5 via NETFX csc)
...
"%CSC%" /nologo /noconfig /nostdlib+ /target:library /langversion:5 /optimize+ /codepage:65001 %REFS% ^
 /out:"%~dp0RuWordListMod.dll" "%~dp0RuWordListMod.cs" "%~dp0BookProfiles.cs"
...
copy /y "%~dp0RuWordListMod.dll" "%GAME%\BepInEx\plugins\RuWordListMod.dll" >nul
if errorlevel 1 (
